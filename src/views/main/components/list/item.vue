...
<script setup lang="ts">
  ...
  const imgTarget = ref<HTMLElement | null>(null)
  ...
  const imgContainerCenter = () => {
    ...
    return {
      translateX: Math.floor(imgContainerX + imgContainerWidth / 2),
      translateY: Math.floor(imgContainerY + imgContainerHeight / 2)
    }
  }
  /**
   * 进入详情点击事件
